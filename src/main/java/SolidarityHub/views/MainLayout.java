...
public class MainLayout extends AppLayout implements RouterLayout {
    ...
    public MainLayout() {
       ...
       notificacionesBadge = new Span();
        ...
        divisorDer.add(notificacionesBtn);
    ...
    private void actualizarDialogoNotificaciones() {
        ...
        if (notificacionesContainer == null) return;
    ...
    private Component crearTarjetaNotificacionResumida(Notificacion notificacion) {
        ...
        tarjeta.getStyle()
                ...
                .set("border-left", notificacion.getEstado() == Notificacion.EstadoNotificacion.PENDIENTE ? 
                      "3px solid var(--lumo-primary-color)" : "3px solid var(--lumo-contrast-10pct)");
